...
# CONFIG
# ==============================
labels_dir = Path(r"D:\Diplomarbeit\Diplomarbeit\Daniel\Diplomarbeit_KI\Dataset\Mapillary\dataset_annotaded\annotations\mtsd_v2_fully_annotated\annotations_yolo_clean")
images_dir = Path(r"D:\Diplomarbeit\Diplomarbeit\Daniel\Diplomarbeit_KI\Dataset\Mapillary\dataset_annotaded\pictures\images_clear")
yaml_file = Path("data.yaml")
finished_folder = Path("Dataset/Videos_Pictures_finished_Mapillary")
...
for label_file in labels_dir.glob("*.txt"):
    candidates = [
        images_dir / (label_file.stem + ".jpg"),
        images_dir / (label_file.stem + ".png"),
        images_dir / (label_file.stem + ".jpeg"),
    ]
    img_file = next((p for p in candidates if p.exists()), None)
    if img_file is None:
        continue
